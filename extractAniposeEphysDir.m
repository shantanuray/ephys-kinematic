function anipose_ephys_loc = extractAniposeEphysDir(anipose_dir)
% anipose_ephys_loc = extract_anipose_ephys_loc(anipose_dir)
...
% init output
anipose_ephys_loc = struct();
anipose_ephys_loc.anipose_dir = anipose_dir;
[rootpath, anipose_label] = fileparts(anipose_dir);
anipose_ephys_loc.label = anipose_label(1:strfind(anipose_label, '_video') - 1);
...
anipose_ephys_loc.ephys_loc = fullfile(oebin_dir_list(oebin_dir_list_indx, :), 'structure.oebin');