...
%% Important: 
%% Alternatively, if you want to run this on select folders only,
%% Comment above function call of processAniposeEphysBatchStartEvent
%% Then initialize AniposeDirList and pass that to batch script (see below)
