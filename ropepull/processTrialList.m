...
figure;
subplot(3,1,1);
plot((1:length(data_dv))/200, data_dv,'k', 'LineWidth',1.5);
xlim([1 2]);
ylim([-60 0]);
subplot(3,1,2);
plot((1:length(data_ml))/200, data_ml,'k', 'LineWidth',1.5);
xlim([1 2]);
ylim([-8 2]);
subplot(3,1,3);
plot((1:length(data_ap))/200, data_ap, 'k', 'LineWidth',1.5);
xlim([1 2]);
ylim([135 155]);
...
figure;
subplot(3,1,1);
plot((1:length(data_elev))/200,data_elev, 'k', 'LineWidth',1.5);
xlim([1 2]);	
ylim([-1.5 1])
subplot(3,1,2);
plot((1:length(data_azi))/200,data_azi, 'k', 'LineWidth',1.5);
xlim([1 2]);
subplot(3,1,3);
