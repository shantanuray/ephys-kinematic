function [spoutContact_ON, spoutContact_OFF, lightON] = plot_computed_mean(trial_list, dataLabel, bodyPart, title_str, fsKinematic, fsEphys, alignBy, annotateON, show_fig, save_fig, save_loc)
% Plots velocity/acceleration data for reach trial for given reach data labels
% Assumption: Data has been precalculated
%
% Usage: plot_computed_mean(trial_list, dataLabel, bodyPart, ...
%                      titlestr,...
%                      fsKinematic, fsEphys, ...
%                      ref2max,annotateON,...
...
%              - 'refMax': Maximum velocity/acceleration
%              - '% reach' (default): align entire reach into 100 samples and plot as % reach (use with first_sc)
