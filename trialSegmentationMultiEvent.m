...
function trial_list = trialSegmentationMultiEvent(aniposeData,...
	...
	[spoutContact_first_solenoid, spoutContact_multi_solenoid, hitormiss_solenoid] = getSpoutContact(solenoid_on, spoutContact_on);
	[spoutContact_first_tone, spoutContact_multi_tone, hitormiss_tone] = getSpoutContact(tone_on, spoutContact_on);
