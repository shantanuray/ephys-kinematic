        ...
        if length(anipose_ephys_loc.ephys_loc)>0
            ...
            for evnt_idx = 1:length(startEvents)
                ...
                if isempty(startTrialTrigger)
                    ...
                    trialListGold = trialSegmentationGold(trial_list, videoFrames_timestamps,'WindowStartLimitValue',5,'WindowSelectorLimitValue',5);
                    processLabels = {'aniposeData_fixed_relative',...
                                     'aniposeData_reach_relative',...
                                     'aniposeData_grasp_relative'};
                    aniposeSamplingRate = 200;
                    trial_list = getVelocityAcceleration(trialListGold, aniposeSamplingRate, processLabels);
